...
$.widgets.Carousell = function(wargs) {
    var _widget = this;
    var items = [];
    var index = 0;
    var showNav = true;
    ...
    this.addItem = function(item) {
        ...
        _sel.append((id + 1)).removeClass().addClass("carousell-id carousell-id-theme");        
    ...
    this.select = function(itemId) {
        for (var _i = 0; _i < items.length; _i++) {
            ...
            if (item.id == itemId) {
                ...
                item.menu.addClass("carousell-id carousell-id-theme carousell-id-selected-theme");
            } else {
                item.menu.removeClass().addClass("carousell-id carousell-id-theme");
            }
        }
    };
    ...
    this.init = function() {
        ...
        _widget.node.addClass("carousell-theme");
